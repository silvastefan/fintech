...
const chatwindowConfig = (isReact = false) => {
    return isReact
        ? `chatWindow: {
                    welcomeMessage: "Olá! Esta é uma mensagem de boas-vindas personalizada",
                    ...
                    botMessage: {
                        ...
                        textColor: "#303235",
                        showAvatar: true,
                        avatarSrc: "https://storage.googleapis.com/ayvo-app/logo_ayvo_chatbot.png",
                    },
                    userMessage: {
                        backgroundColor: "#3B81F6",
                        textColor: "#ffffff",
                        ...
                        <>
                            <span>
                                ...
                                <p>
                                    ...
                                    :&nbsp;<code>{`https://storage.googleapis.com/ayvo-app/web.js`}</code>
                                </p>
                            </span>
